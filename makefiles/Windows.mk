...
lint: ## check style with flake8
	flake8 cookietemple_website tests
...
coverage: ## check code coverage quickly with the default Python
	coverage run --source cookietemple_website -m pytest
	coverage report -m
	coverage html
	$(BROWSER) htmlcov\index.html

docs: ## generate Sphinx HTML documentation, including API docs
	del /f /q docs\cookietemple_website.rst
	del /f /q docs\modules.rst
	sphinx-apidoc -o docs\ cookietemple_website
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
